...
import type { ContextMenuCommand } from "@/events/interactionCreate/command/contextMenuCommand";

export { ContextMenuCommand } from "@/events/interactionCreate/command/contextMenuCommand";
